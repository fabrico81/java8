...
/*
    ...
    String [] srt2 = {"a", "b", "c"};
        ...
        int x = 12;
        int y = DataStructures.binarySearch(random, x);
        System.out.println(y);

        List<Integer> list = DataStructures.asList(10, 4, -1, 5);
        ...
        List<String> list = DataStructures.asList(names);
        list.set(0, "Sue");
        System.out.println(names[0]);


        List<String> hex = DataStructures.asList("30", "8", "3A", "FF");
